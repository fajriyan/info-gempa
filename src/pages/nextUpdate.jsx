    ...
    if (loadGT || loadGD) {
      return (
        <div className="animate-pulse ">
          <div
            className={`mt-[5px] bg-violet-200 h-3 w-${
      ...
      <div className="container mx-auto mt-3 mb-10 ">
        ...
        <div className="grid px-3 grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-3 ">
          ...
          <div className="lg:col-span-2">
              ...
              <ul className="text-sm list-disc pl-5">
                <li>
                  <span className="flex gap-1 ">
                    Dirasakan : <Skeleton width={40} />
                    {GT?.dirasakan}
                  </span>
                </li>
                <li>
                  <span className="flex gap-1">
                    Wilayah : <Skeleton width={52} /> {GT?.wilayah}
                  </span>
                </li>
                <li>
                  <span className="flex gap-1 flex-grow">
                    Potensi : <Skeleton width={40} />
                    {GT?.potensi}
                  </span>
                </li>
              </ul>
            ...
            <div className="mt-3 rounded-lg border p- overflow-x-scroll">
              <div className="border-b px-3 py-2 sticky top-0 bg-white">
                <h2 className="font-semibold text-sm text-gray-900">
                  #Data 3 Gempa Yang Dirasakan
                </h2>
              </div>
